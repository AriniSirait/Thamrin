		...
		<!-- widget Edit -->
			<div class="widget">
              ...
              <div class="control-group">
			          ...
			          <div class="controls">
									<input type="text" name="customer" placeholder= "<?php echo $hasil['customer']; ?>" value= "<?php echo $hasil['customer']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="terminal_id" placeholder= "<?php echo $hasil['terminal_id']; ?>" value= "<?php echo $hasil['terminal_id']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="msn" placeholder= "<?php echo $hasil['msn']; ?>" value= "<?php echo $hasil['msn']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="tipe_mesin" placeholder= "<?php echo $hasil['tipe_mesin']; ?>" value= "<?php echo $hasil['tipe_mesin']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="address" placeholder= "<?php echo $hasil['address']; ?>" value= "<?php echo $hasil['address']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="city" placeholder= "<?php echo $hasil['city']; ?>" value= "<?php echo $hasil['city']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="service_area" placeholder= "<?php echo $hasil['service_area']; ?>" value= "<?php echo $hasil['service_area']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="installation_date" placeholder= "<?php echo $hasil['installation_date']; ?>" value= "<?php echo $hasil['installation_date']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="group" placeholder= "<?php echo $hasil['group']; ?>" value= "<?php echo $hasil['group']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="ceowner" placeholder= "<?php echo $hasil['ceowner']; ?>" value= "<?php echo $hasil['ceowner']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="remarks2" placeholder= "<?php echo $hasil['remarks2']; ?>" value= "<?php echo $hasil['remarks2']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="status" placeholder= "<?php echo $hasil['status']; ?>" value= "<?php echo $hasil['status']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="coverage" placeholder= "<?php echo $hasil['coverage']; ?>" value= "<?php echo $hasil['coverage']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="start_date" placeholder= "<?php echo $hasil['start_date']; ?>" value= "<?php echo $hasil['start_date']; ?>" class="input-medium" />
		            ...
		            <div class="controls">
									<input type="text" name="end_date" placeholder= "<?php echo $hasil['end_date']; ?>" value= "<?php echo $hasil['end_date']; ?>" class="input-medium" />
